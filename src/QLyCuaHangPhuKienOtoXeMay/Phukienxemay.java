...
public class Phukienxemay extends SanPham implements INhap, IXuat {
...
//    public Phukienxemay(int maSanPham, String tenSanPham, double giaBan, double giaNhap,
//                      String loaiXe, NhaCungCap nhaCungCap, int soLuongTon, int soLuongNhap, int soLuongSanPham) {
//        super();
//        this.mauSac = mauSac;
...
//    public Phukienxemay(int maSanPham, int soLuongTon, int soLuongNhap, double giaBan, double giaNhap,
